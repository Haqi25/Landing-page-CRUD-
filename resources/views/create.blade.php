    ...
    <div class="min-h-screen bg-[#0C0B12] p-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] p-10 shadow-2xl">
                <h2 class="text-3xl font-bold text-white mb-2">Tambah Produk</h2>
                @if ($errors->any())
                    <div role="alert">
                ...
                <form action="{{ route('dashboard.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_produk" placeholder="Contoh: Pasta gigi "
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="harga" placeholder="25000000"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="5" placeholder="Jelaskan detail Produk"
                            class="w-full bg-[#16151D] border border-white/10 rounded-xl px-5 py-4 text-white focus:outline-none focus:border-[#534581] transition"></textarea>
                    </div>
